...
- OAuth and optional feature values such as `KAKAO_REST_API_KEY`, `KAKAO_CLIENT_SECRET`, `GOOGLE_WEB_CLIENT_ID`, `GOOGLE_ALLOWED_ISSUERS`, and `FCM_ENABLED` as required by the deployment.
